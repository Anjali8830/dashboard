...
export const DEPT_BG = {
  Engineering: 'rgba(124,107,255,0.12)',
  Marketing:   'rgba(255,107,157,0.12)',
  Sales:       'rgba(0,212,170,0.12)',
  HR:          'rgba(255,181,71,0.12)',
  Finance:     'rgba(99,179,237,0.12)',
};

export const AVATAR_COLORS = ['#7c6bff','#ff6b9d','#00d4aa','#ffb547','#63b3ed','#f87171','#a78bfa','#34d399'];

export const LOCATION_FLAGS = {
  'New York': '🗽', 'Los Angeles': '🌴', 'Chicago': '🏙️',
  'Austin': '🤠', 'Miami': '🌊', 'Seattle': '🌧️', 'Denver': '⛰️', 'Phoenix': '☀️'
};
